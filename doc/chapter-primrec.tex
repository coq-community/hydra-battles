...
You may find also  definition of the Ackermann function and a few  lemmas in
 \href{../theories/ordinals/Prelude/Ack.html}%
{ordinals.Prelude.Ack}. 
...
The lemmas which are marked as \textbf{Done} are proved
in the library \texttt{ordinals.Prelude.Ack}.
