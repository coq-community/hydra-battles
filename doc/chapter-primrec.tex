...
$\texttt{PrimRec}\,n \rightarrow  \texttt{naryFunc}\,n$ , together with the  function 
...
Thus, our first subgoal is solved easily and the proof ends, applying already proven lemmas.
...
multiplication with the identity and the constant function wihich returns $2$.
...
%\input{alec-extract2} % essai avec alectryon TODO retry
...
The three firts lemmas make us sure that our function 
