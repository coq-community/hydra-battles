...
We prefered to use the former definition, in order to
...
\begin{remark}
It is easy to prove that any unary function which dominatates \texttt{fun n => Ack n n} fails to be primitive recursive. We use an instance on \texttt{majorAnyPR} for unary functions.
\vspace{4pt}
\noindent
