...
\subsection{The length of standard hydra battles}
...
\emph{Please note that our proof of this lemma is not trivial at all. It uses some lemmas of Chapters~\vref{chap:ketonen} and \vref{chap:alpha-large}.}
...
\begin{Coqsrc}
H_L_ : forall (alpha : E0) (i : nat), H_ alpha i <= L_ alpha (S i)
\end{Coqsrc}
