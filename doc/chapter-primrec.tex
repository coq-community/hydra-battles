...
Since The Ackermann function is strictly monotonous in its first argument\footnote{almost always\dots}, we may replace the large inequality with a strict one.
