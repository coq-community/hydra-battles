...
Show also that, for any $n$ and $m$, $A\,n\,m \leq A\,(n+1)\,m$. \emph{\textbf{To do.}}
...
for any $x_1,\dots\,x_k$, $f(x_1,\dots,x_k)\leq A\,n\,(x_1+\dots+x_k)$. \emph{\textbf{To do.}}
\item Show that the Ackermann function is not primitive recursive. \emph{\textbf{To do.}}
