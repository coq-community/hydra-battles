...
This example of Fibonacci numbers has been developed with Yves Bertot, who wrote a first version with \texttt{SSreflect/Mathcomp}~\cite{MCB}. This original version is available on
\href{../theories/html/additions.fib.html}{additions.fib}.
