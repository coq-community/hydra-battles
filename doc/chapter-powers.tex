...
\emph{From Module 
\href{../src/html/addition.power.FirstSteps.html}{\texttt{Powers.FirstSteps}}}
...
The number of multiplications needed to compute $x^n$ via this function is linear with respect to $n$. Despite this lack of efficiency, and thanks to its simplicity, we keep it as a specification for more efficient and complex exponentiation algorithms.
...
\emph{From Module
\href{../src/html/addition.power.FirstSteps.html}{Powers.FirstSteps}}
...
\index{Fibonacci numbers!Matrix exponentiation}
...
\label{op-classes}
\index{Type Classes!Operational Type Classes}
...
\emph{From Module \href{../src/html/addition.power.Monoid_def.html}{Powers/Monoid\_def.v}.}
...
\emph{From Module \href{../src/html/addition.power.Monoid_def.html}{Powers.Monoid\_def}}
...
The following class definition, from Module \href{../src/html/addition.power.Monoid_def.html}{Powers.Monoid\_def},
...
File~\href{../src/html/addition.power.Monoid_instances.html}{Powers/Monoid\_instances.v}.
...
\emph{From Module \href{../src/html/addition.power.Monoid_instances.html}{Powers.Monoid\_instances}}
...
The  module \href{../src/html/addition.power.Pow.html}{Powers.Pow} defines two functions for exponentiation on any 
...
From Module~\href{../src/html/addition.power.Demo_power.html}{Powers.Demo\_power}
...
\vspace{4pt}
\emph{From Module~\href{../src/html/addition.power.Pow.html}{Powers.Pow}}
...
\vspace{4pt}
From Module~\href{../src/html/addition.power.Pow.html}{Powers.Pow}
...
~\href{../src/html/addition.power.Pow.html}{Powers.Pow} is devoted to the proof 
...
\begin{itemize}
\item Continuation Passing Style (CPS) \index{Programming Styles!Continuation Passing Style (CPS)} \cite{reynolds93}
...
\item Like in Parametric Higher Order Abstract Syntax (PHOAS)~\cite{PHOAS}, \index{Parametric Higher-Order Abstract Syntax (PHOAS)}
...
From Module~\href{../src/html/addition.power.Chains.html}{Powers.Chains}
...
\index{Advanced proof techniques!Proof by reflection}
...
This tactic is not adapted to much bigger exponents. In \linebreak
 Module~\href{../src/html/addition.power.Euclidean_Chains.html}{Euclidean\_Chains},
...
\index{Advanced proof techniques!Parametricity}
...
All the \coq{} material described in this section is available on 
 Module~\href{../src/html/addition.power.Euclidean_Chains.html}{Powers/Euclidean\_Chains.v}
...
\index{Programming Styles!Continuation Passing Style (CPS)}
...
\index{Dependently Typed Functions}
...
Module ~\href{../src/html/addition.power.Dichotomy.html}{Powers.Dichotomy} contains a definition of the function \texttt{delta}, and proofs that if 
...
%\subsection{Optimality and Relative Efficiency}

% \begin{project}[Proof techniques]
% \noindent
