...
This example of Fibonacci numbers has been developed with Yves Bertot, who wrote a first version with \texttt{SSreflect/Mathcomp}~\cite{MCB}. This original version is available on hydra-battles in the module \href{../theories/html/additions.fib.html}{additions.fib}.
...
subgoal of the previous proof generated after a sequence of unfoldings and simplifications. This goal is presented in Figure~\vref{fig:big-goal}.
