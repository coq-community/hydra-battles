...
Please define an Euclidean chain generator using this data structure, and prove its correctness (partially solved in ~\href{../theories/html/hydras.additions.AM.html}{additions.AM}).
\end{project}
