...
This proof, as it appears inw, is quite dense and qualified as ``a bit tricky''. We present here its main steps with the help of the \alectr tool.
...
In every case, the considered ordinal is accessible. By the definition of accessibility, the ordinal \texttt{(cons a n b)} is accessible, which ends the proof. The reader is invited to replay the full proof in  \href{https://github.com/coq-community/gaia/blob/master/theories/ssete9.v}{gaia.ssete9.v}, and to compare with
