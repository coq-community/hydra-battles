...
\subsubsection{Well-formed ordinal terms}
...
Mainly by rewriting, we import a few properties of the $F_\alpha$s.

\inputsnippets{T1Bridge/MonoDef, GF_alpha/FAlphaProps}.
