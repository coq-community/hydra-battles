...
\inputsnippets{T1Bridge_use/T1BridgeUseb}
...
From now on, names like  \texttt{T1}, \texttt{omega}, etc. are  bound to \HydrasLib' meaning.

 \inputsnippets{ T1Bridge_use/LocateT1, T1Bridge_use/T1BridgeUseb}

\subsection{Porting theorems from \HydrasLib}
