...
Let us give the \gallina terms of opur toy language, corresponding to the terms $a$,
$f(a)$, and $h(f(a),a)$. The ``term'' $h(a)$ is not well formed, since the arity of $h$ is not respected.
...
\inputsnippets{FolExamples/beforeAbbreviations, FolExamples/termAbbreviations, FolExamples/NowItsBetter}
