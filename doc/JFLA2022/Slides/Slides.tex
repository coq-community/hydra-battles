...
\begin{tikzpicture}[thick]
  ...
  \begin{scope}[yshift=2.0cm, xshift=1.7cm] 
     \node[ellipse, dotted, fill=orange!20, minimum height=0.5cm,minimum width=1.5cm] (settheory) { Set theory\footnote{N. Bourbaki}};
     \node[ellipse, dotted, fill=orange!20, minimum height=0.5cm,minimum width=1.5cm, left of=settheory, node distance=8.4cm] (prooftheory) { Proof theory\footnote{K. Schutte, J. Ketonen, R. Solovay, L. Kirby \& J. Paris}};
  \node[ellipse, dotted, fill=orange!20, minimum height=0.5cm,minimum width=1.5cm, left of=settheory, node distance=4.8cm] (algo) { Algorithmics\footnote{S. Brlek \emph{et. al}}};
\end{scope}

\begin{scope}[yshift=1.0cm, xshift=-1.5cm]
...
\node[rectangle, draw=black,minimum height=0.5cm,minimum width=1.5cm,node distance=2cm,left of=paramcoq, node distance=4.1cm] (equations) { Equations };
\end{scope}
