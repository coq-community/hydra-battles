...
\begin{frame}
 ...
 Cf.  \textcolor{pauillac}{Pauillac 2006} and \textcolor{banyuls}{Banyuls 2018}. Today, let us focus on some combinatorial aspects (number of rounds of a battle).
\end{frame}
...
\only<2>{OK for large enough $i$ (K. \& S., 1981)}
\vspace{6pt}
