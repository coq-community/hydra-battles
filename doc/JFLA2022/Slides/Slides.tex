...
\begin{frame}
  ...
  \TODO{}{Develop the abstract and background of the paper}
\end{frame}
...
\begin{frame}
  \begin{block}{}
    The functions \textcolor{mathcolor}{$H'_\alpha$} are implemented with \textcolor{plugincolor}{coq-equations}.
    \vspace{5pt}
    \begin{footnotesize}
