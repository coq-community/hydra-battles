...
\begin{frame}[fragile]
  \begin{block}{Examples}
    ...
    Using the lemmas generated by \emph{coq-equations}, we prove minoration lemmas or exact formulas for given $\alpha$\,s:
    
    \begin{itemize}
    \item \input{../../movies/snippets/Hprime/HprimeOmegaCube3c}
      \input{../../movies/snippets/Hprime/HprimeOmegaCube3e}
     \item   \input{../../movies/snippets/Hprime/HprimeHexp2}
    \item
...
\emph{We use   Russel O'Connor's formalization of PR functions.}
  \end{block}
...
\begin{frame}
  \begin{block}{}
    ...
    \end{quote}
       ...
       \input{../../movies/snippets/F_omega/lemmas}
