...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Uncomment if there's time enough
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Ordinals: a short reminder}
...
&\textcolor{red}{\omega^{\omega^\omega}},\ldots, \textcolor{red}{\omega^{\omega^\omega}+\omega^\omega\times 42+ \omega^{55}+\omega}, \ldots, \textcolor{red}{\omega^{\omega^{\omega+1}}}, \omega^{\omega^{\omega+1}}+1,\dots\\
     & \textcolor{red!55}{\epsilon_0 (= \omega^{\epsilon_0)}},
       \textcolor{black!55}{\epsilon_0+1}, \textcolor{black!55}{\epsilon_0+2}, \textcolor{black!55}{\epsilon_0+3}, \ldots\\
& \textcolor{red!45}{\epsilon_1}, \ldots, \textcolor{red!45}{\epsilon_2}, \ldots, \textcolor{red!45}{\epsilon_\omega},\ldots \\
& \textcolor{red!40}{\Gamma_0}, \textcolor{black!40}{\Gamma_0+1}, \textcolor{black!40}{\Gamma_0+2}, \textcolor{black!40}{\Gamma_0+3},\ldots, \textcolor{red!40}{\Gamma_0+\omega}, \ldots\\
&\ldots
  \end{align*}   
  \end{minipage}}}
...
\begin{frame}
  ...
  \begin{block}{}
    ...
    Canonical sequences are implemented by a structurally recursive function on terms in Cantor normal form.
...
\begin{frame}[label={accessibility}]
    ...
    \frametitle{Example: Paths and accessibility}
    \begin{block}{ }
...
\node (epsilon0) at (-3,0) {\textcolor{black!60}{$(\epsilon_0>\;)$}};
...
\only<2>{{\color{lookcolor}If $i$ is large enough, we are sure to reach $\beta$ (K. \& S., 1981)}}
\vspace{6pt}

% \pause
\only<1>{Can we  reach \textcolor{red}{$\beta$} from $\alpha$? Under which condition? }

\vspace{4pt}

\only<2>{\textbf{Cor:} There is no decreasing measure mapping hydras to  $[0, \mu)$ (for any $\mu<\epsilon_0$)  for proving the termination of \textcolor{lookcolor}{\emph{the considered kind of}} hydra battles
