...
\definecolor{plugincolor}{rgb}{0.0,0.0,0.0}
...
\begin{frame}
  ...
  \begin{block}{}
    ...
    \textcolor{mathcolor}{Discrete math}, discuss
    \textcolor{coqstylecolor}{\coq style, specification and proof patterns}, and use  \textcolor{plugincolor}{a few plug-ins}.
  \end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]
  \frametitle{Tests with Beamer(1)}
  \begin{footnotesize}
...
\end{frame}
  \begin{frame}[fragile]
    \frametitle{Tests with Beamer(2)}
