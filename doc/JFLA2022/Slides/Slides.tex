...
\end{figure}
In terms of ordinals, we consider  the sequence
$\langle \omega^{\omega^2+1}+1, \omega^{\omega^2+1},\omega^{\omega^2}\times 3,
\omega^{\omega^2}\times 2+\omega^{\omega}\times 4,\dots,1,0\rangle$.
\end{frame}
