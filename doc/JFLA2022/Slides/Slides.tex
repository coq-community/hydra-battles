...
\begin{scope}[yshift=-5cm,xshift=4cm]
  \node[rectangle, draw=black,fill=orange!80,minimum height=0.5cm,minimum width=1.5cm] (book) {hydras.pdf};
    \node[rectangle, draw=black,fill=orange!80,minimum height=0.5cm,minimum width=1.5cm, left of=book, node distance=6cm] (latex) {hydras.tex};
\end{scope}
...
\inputsnippets{./HprimePhi0OmegaClosed}
