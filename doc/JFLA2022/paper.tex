...
kind of hydra battles we consider is not given by any primitive recursive function, we chose to use a formalization of primitive recursive functions that was originally part of Russell O'Connor's formalization of G\"{o}del's first incompleteness theorem~\cite{OConnor05, Goedel}.
