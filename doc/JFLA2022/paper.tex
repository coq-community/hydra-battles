...
\begin{abstract}
  \emph{Hydra-battles} is a collaborative library on discrete math, written for the Coq proof assistant, and developped under the \emph{Coq-Community} project. The proof scripts are
