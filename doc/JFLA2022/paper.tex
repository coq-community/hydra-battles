...
\begin{abstract}
  ...
  Then, we show how the structure of the project is determined   by two  requirements which must be continuously satisfied.
   First, the Coq code needs to be continuously maintained for compatibility with its dependencies (the Coq proof assistant and several Coq packages from inside and outside \community) and reverse dependencies (\community projects that depend on it).
