...
Using $H'$s equations as rewrite rules, we can study a concrete example of hydra battle. Let us start with the hydra of figure~\ref{fig:start} and $0$ as initial step.
By a combination of rewriting and induction, we prove that the number of steps of the considered battle has at least $2^{10^{21}}$ binary digits. 
