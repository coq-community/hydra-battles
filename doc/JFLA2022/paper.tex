...
In practice, we do still support building the whole project with \coqmakefile, and we actually rely on this build system in our documentation generation pipeline.
