...
\begin{abstract}
  \emph{Hydra-battles} is a collaborative library on discrete math, written for the {\coq}  proof assistant, and developed under the \community project. The proof scripts are
