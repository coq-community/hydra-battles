...
\begin{theorem}
  Let $\mu$ be an ordinal strictly less than $\epsilon_0$.
  There is no function mapping hydras to the segment $[0,\mu)$ that could be a measure used in proving the termination of  \emph{any} hydra battle.\label{thm3}
\end{theorem}
