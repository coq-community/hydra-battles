...
\TODO[Pierre]{
  Using the equations of $H'$ as rewrite rules, we studied the
  number of steps  of the battle starting with the hydra of Figure~\ref{fig:start} and $0$ as initial step. This number has
