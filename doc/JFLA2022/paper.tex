...
\end{tikzpicture}
  ...
  \caption{Two successive states of a hydra in a battle.  Hercules chopped off the rightmost head of the hydra, and the whole left tree except the root node was copied twice.}
  \label{fig:round}
\end{figure}
