...
Using $H'$ equations as rewrite rules, we can study a concrete example of hydra battle. Let us start with the hydra of figure~\ref{fig:start} and $0$ as initial step.
