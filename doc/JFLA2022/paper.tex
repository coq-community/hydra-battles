...
\begin{abstract}
  ...
  We present its evolution since a former presentation and how its structure is determined by other
...
$H'_\alpha(i)-i$, where $H'$ is a slight variant of the Hardy hierarchy of rapidly growing functions~\cite{BW85, KS81, Promel2013, Wainer1970}.  The function $H'_\alpha$ is defined by transfinite recursion over $\alpha$:
...
Figure~\ref{fig:Hprime} 
 shows the  definition of $H'$ with the \texttt{coq-equations}
 plug-in~\cite{sozeau:hal-01671777}.

 \begin{figure}[h]
 \inputsnippets{HprimeDef}
\caption{Coq Equations for $H'$}
\label{fig:Hprime}
\end{figure}
