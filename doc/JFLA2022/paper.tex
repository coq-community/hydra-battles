...
\hline
\textbf{Package name} & \textbf{Repository} & \textbf{Package index identifier} & \textbf{Version} & \textbf{Spec LOC} & \textbf{Proof LOC}\\
\hline
