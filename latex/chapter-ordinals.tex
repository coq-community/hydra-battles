...
The following type class describes a well-ordered type, and specifies functions for comparing two ordinals, and checking wether a given  ordinal is $0$, a limit or a successor.
