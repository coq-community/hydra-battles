...
In some cases we want to show that two notation systems describe the same segment (for instance $3+\omega$ and $\omega$). For that purpose, one may prove that the two notation systems are order-isomorphic.
...
The simplest example of ordinal notation is 
