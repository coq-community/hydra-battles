...
&\textcolor{red}{\omega^\omega2},\ldots, \textcolor{red}{\omega^\omega\times 2},\ldots,\\
...
& \textcolor{red}{\epsilon_0 (= \omega^\epsilon_0)}, \epsilon_0+1, \ldots,\\
...
\item Ordinals that follow dots (written in red) are called \emph{limit ordinals}. With respect to the order induced by this sequence, any limit ordinal $\alpha$ is the least upper bound of  the set $\mathbb{O}_\alpha$ of all ordinals strictly less than $\alpha$.
