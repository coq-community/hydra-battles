...
Lemma paZeroOrSucc (t : Term):
 ...
 SysPrf PA (t = LNT.Zero \/ exH nv, t = LNT.Succ (v#nv))%nt.
  ...
  -- elim (newVar1 (0 :: freeVarT LNT t)).
     fold nv; simpl; auto.
  -- induction (In_dec eq_nat_dec nv (freeVarT LNT (LNT.Succ (v#0))%nt)) 
       as [a | b0].
     ++ elim (newVar1 (0 :: freeVarT LNT t)).
        fold nv in |- *.
        simpl in a.
...
Proof.
  ...
  { apply induct.
    - rewrite (subFormulaForall LNT).
      ...
      + discriminate a.
      + induction (In_dec eq_nat_dec 0 (freeVarT LNT LNT.Zero)) as [a | b0].
        * elim a.
        * apply induct.
    ...
    - apply forallI.
      ...
      + apply impI.
        ...
        induction (eq_nat_dec 0 1) as [a | b].
        * discriminate a.
        * induction (In_dec eq_nat_dec 0 (freeVarT LNT (LNT.Succ (v#1))%nt)).
...
(allH 1 0,
  ...
  - rewrite (subFormulaForall LNT).
    ...
    + discriminate a.
    + induction (In_dec eq_nat_dec 0 (freeVarT LNT LNT.Zero)).
      * simpl in a.
        elim a.
      * rewrite (subFormulaOr LNT).
        ...
        -- apply impI.
           ...
           ++ discriminate a.
           ++ induction (In_dec eq_nat_dec 3 (freeVarT LNT LNT.Zero)).
              ** elim a.
