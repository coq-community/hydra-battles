...
Proof. 
  ...
  - assert (H: lt_depth L f (forallH v f)) by apply depthForall.
    ...
    + set (nv := newVar (v :: freeVarT L s ++ freeVarF L f)).
            ...
            ++  rewrite evalStrongRecHelp1 with
                ...
                ** rewrite evalStrongRecHelp1 with
                   ...
                   replace
                     ...
                     with
                     (newVar (v0 :: freeVarT L s ++ freeVarF L a)).
...
- intros t t0 v s n m H; unfold evalStrongRec in H.
  ...
  induction
    (eq_nat_dec n
       (cPair 0
          (cPair (code.codeTerm cL (substT L t v s))
             (code.codeTerm cL (substT L t0 v s))))) as [a | b].
      ...
      -- rewrite evalStrongRecHelp1 with (m := cdr m) in H0.
         ++ simpl in H0.
            ...
            ** rewrite <- a1 in H0.
               rewrite Nat.eqb_refl in H0.
               induction
                 (eq_nat_dec (cTriple v0 (code.codeTerm cL s) (cTriplePi2 (car m)))
               ...
               --- rewrite a2 in H0.
                   ...
                   *** rewrite <- (H _ H5 _ _ _ _ H2) in a1.
                       ...
                       replace (S (cPair v0 (codeList 
                                               (freeVarT L s ++ freeVarF L a))))
                         with (codeList (v0 :: freeVarT L s ++ freeVarF L a));
                         [ idtac | reflexivity ].
                       rewrite codeNewVarCorrect.
                       reflexivity.
                   +++ rewrite nat_eqb_false in H0.
    ...
    * rewrite evalStrongRecHelp1 with (m := m) in H0.
      -- simpl in H0.
         ...
         ++ rewrite <- a0 in H0.
            rewrite Nat.eqb_refl in H0.
            induction
              (eq_nat_dec (cTriple v0 (code.codeTerm cL s) (codeFormula a))
                 (cTriplePi1 m)) as [a1| ?].
            ** rewrite <- a1 in H0.
               rewrite Nat.eqb_refl in H0.
               simpl in H0.
...
Proof.
    ...
    (P0 := fun (n : nat) (ts : fol.Terms L n) =>
             forall (v : nat) (s : fol.Term L),
               codeTerms cL n (substTs L n ts v s) <=
                 ReplaceTermsTerm (codeTerms cL n ts)
  ...
  - replace
    ...
    * replace (codeTerms cL (S n) (Tcons t0 t1)) with
        (S (cPair (codeTerm t0) (codeTerms cL n t1))); 
        [ idtac | reflexivity ].
      -- simpl; repeat rewrite cPairProjections1.
         apply le_n_S.
         apply cPairLe3.
         ...
         ++ eapply Nat.le_trans.
            ...
            ** repeat rewrite cPairProjections2.
               apply
                 (ReplaceTermsTermMonotone (codeTerms cL  n t1)
...
Proof.
  ...
  - intros v s; 
    ...
    + replace (codeTerms cL (S n) (Tcons t ts)) with
        (S (cPair (codeTerm t) (codeTerms cL n ts))); 
        [ idtac | reflexivity ].
      simpl; repeat rewrite cPairProjections1.
      ...
      * eapply Nat.le_trans.
        ...
        -- repeat rewrite cPairProjections2.
           apply
             (ReplaceTermsTermMonotone (codeTerms cL n ts)
           ...
           ++ replace (freeVarTs L (S n) (Tcons t ts)) 
                ...
                [ idtac | reflexivity ].
              apply maxLemma3.
    + replace (codeTerms cL (S n) (Tcons t ts)) 
        with  (S (cPair (codeTerm t) (codeTerms cL n ts))); 
        [ idtac | reflexivity ].
      simpl; repeat rewrite cPairProjections2.
      apply Nat.lt_succ_r.
      apply cPairLe2.
...
Proof.
  ...
  simpl in H;
    ...
    (P0 := fun (n : nat) (ts : fol.Terms L n) =>
             forall v w s2 : nat,
               ReplaceTermsTerm
                 (codeTerms cL n (substTs L n ts v (var w))) s2 =
                 ReplaceTermsTerm (codeTerms cL n ts) s2); 
    simpl in |- *; intros; unfold evalStrongRec in |- *;
    unfold evalComposeFunc, evalOneParamList, evalList in |- *;
    repeat rewrite computeEvalStrongRecHelp; unfold compose2 in |- *;
    unfold evalComposeFunc, evalOneParamList, evalList in |- *; 
      ...
      replace
        (cdr
           (evalStrongRec 1 A
              ...
              s2)) with
        (cdr
           (evalStrongRec 1 A (codeTerms cL (arityF L f) t0)
              s2)); [reflexivity | ].
    ...
    + replace
        ...
        (S
           (cPair (codeTerm (substT L t0 v (var w)))
              (codeTerms cL n (substTs L n t1 v (var w)))));
        [ idtac | reflexivity ].
      ...
      replace
        (car
           (evalStrongRec 1 A
              (car (cPair (codeTerm t0) (codeTerms cL n t1))) s2)) 
        with
        (car
           (evalStrongRec 1 A
              (car
                 (cPair (codeTerm (substT L t0 v (var w)))
                    (codeTerms cL n (substTs L n t1 v (var w))))) s2)).
      * replace (cdr (evalStrongRec 1 A (codeTerms cL n t1) s2)) 
          with
          (cdr
             (evalStrongRec 1 A
                (codeTerms cL n (substTs L n t1 v (var w))) s2)).
...
Lemma ReplaceTermsTermSub :
 ...
 ReplaceTermsTerm (codeTerms cL n (substTs L n ts v (var w))) s2 =
 ReplaceTermsTerm (codeTerms cL  n ts) s2.
Proof.
    ...
    + replace
        ...
        (S
           (cPair (codeTerm (substT L t v (var w)))
              (codeTerms cL n (substTs L n ts v (var w)))));
        [ idtac | reflexivity ].
      replace (codeTerms cL (S n) (Tcons t ts)) 
        with
        (S (cPair (codeTerm t) (codeTerms cL n ts))); 
      ...
      replace
        (car
           (evalStrongRec 1 A
              (car (cPair (codeTerm t) (codeTerms cL n ts))) s2)) 
        with
        (car
           (evalStrongRec 1 A
              (car
                 (cPair (codeTerm (substT L t v (var w)))
                    (codeTerms cL  n (substTs L n ts v (var w))))) s2)).
      * replace (cdr (evalStrongRec 1 A (codeTerms cL n ts) s2)) 
          with
          (cdr
             (evalStrongRec 1 A
                (codeTerms cL n (substTs L n ts v (var w))) s2)).
    ...
    + induction (In_dec eq_nat_dec v (freeVarT L (var w))) as [a0 | ?].
      * simpl; unfold evalStrongRec, evalComposeFunc, evalOneParamList, evalList.
          ...
          (m := 
             codeFormula
               (substF L
                  (substF L a v
                     (var
                        (newVar (v0 :: freeVarT L (var w) ++ freeVarF L a))))
                  v0 (var w))).
        -- rewrite H with (m := codeFormula a).
           ...
           apply cPairLt2.
        -- apply Nat.le_lt_trans with
             (cPair (newVar (v0 :: freeVarT L (var w) ++ freeVarF L a))
                (codeFormula
                   (substF L
                      (substF L a v
                         (var
                            (newVar
                               (v0 :: freeVarT L (var w) ++ freeVarF L a))))
                      v0 (var w)))).
           ++ apply cPairLe2.
           ++ apply cPairLt2.
      * simpl;
...
Proof.
  ...
  - intros n t H t0 H0; replace (freeVarTs L (S n) (Tcons t t0)) 
    ...
    replace (codeTerms cL (S n) (Tcons t t0))
      with
      (S (cPair (codeTerm t) (codeTerms cL n t0))); 
      [ idtac | reflexivity ].
...
Proof. 
  unfold newVar; apply Nat.le_trans with 
    (S (fold_right Nat.max 0 (v0 :: freeVarT L s ++ freeVarF L a))).
  - apply mapListLemma.
  - apply le_n_S; simpl; apply maxLemma.
    + apply le_n.
    + induction (maxApp (freeVarT L s) (freeVarF L a)) as [a0 | b]. 
...
Remark boundSubFormulaHelp1 :
  forall (b a : fol.Formula L) (v0 v : nat) (s : fol.Term L),
    fold_right Nat.max 0
      (varFormula
         (substF L b v
            (var (newVar (v0 :: freeVarT L s ++ freeVarF L a))))) <=
...
Proof.
  ...
  - intros v a H a0 v0 v1 s;
    ...
    + induction
      (In_dec eq_nat_dec v
         (freeVarT L
            (var (newVar (v0 :: freeVarT L s ++ freeVarF L a0)))))
        as [a1 | b1].
    ...
    ** simpl; apply le_n_S.
       apply
         (Nat.max_case v1
            (Nat.max (newVar (v0 :: freeVarT L s ++ freeVarF L a0))
               (fold_right Nat.max 0 (freeVarF L a)))).
       apply le_S.
       do 2 (eapply Nat.le_trans; [ idtac | apply Nat.le_max_r ]).
       apply Nat.le_max_l.
       apply
         (Nat.max_case (newVar (v0 :: freeVarT L s ++ freeVarF L a0))
        ...
        ++  rewrite subFormulaDepth.
            ...
            ** apply
               ...
               apply H with
                 ...
                 (v0 := v1)
                 (a := a)
                 (s := var (newVar (v0 :: freeVarT L s ++ freeVarF L a0))).
               apply depthForall.
               rewrite
...
Proof.
  ...
  - intros; unfold evalStrongRec, evalComposeFunc, evalOneParamList, evalList.
    ...
    + apply le_n.
    + apply Nat.le_trans  with
        (ReplaceTermsTerm (codeTerms cL _ t)
        ...
        -- simpl; apply cPairLe3.
           ...
           ++ unfold C; eapply Nat.le_trans; [ idtac | apply Nat.le_max_r ].
              ...
              ** simpl; unfold nv, newVar.
                 ...
                 simpl; apply maxLemma.
                 apply le_n.
                 induction (maxApp (freeVarT L s) (freeVarF L a)) as [a1 | b1].
                 --- rewrite a1.
                     apply maxLemma2.
                         ...
                         (pow3 (depth L a) +
                            fold_right Nat.max 0
                              (v
                                 ...
                                 varFormula a))) <= C).
              { assert
                  (H2: newVar (v0 :: freeVarT L s ++ freeVarF L a) <=
                         pow3 (depth L a) +
                ...
                - replace
                    (codeTerm (var (newVar (v0 :: freeVarT L s ++ 
                                              freeVarF L a)))) 
                    with
                    (cPair 0 (newVar (v0 :: freeVarT L s ++ freeVarF L a)));
                    [ idtac | reflexivity ].
                  unfold C; eapply Nat.le_trans; [ idtac | apply Nat.le_max_r ].
                  apply cPairLe3.
                  + apply le_n.
