...
Proof.
  move => Halpha; rewrite /E0limit /L_  L_lim_eqn /E0Canon; f_equal.
...
Definition L_spec (alpha:T1) (f: nat -> nat):= Large_Sets.L_spec (g2h alpha) f.

Theorem L_correct alpha : L_spec (cnf alpha) (L_ alpha).
Proof.  apply (L_alpha.L_correct (E0_g2h alpha)). Qed. 

Theorem H'_L_ alpha i: (GHprime.H'_ alpha i <= L_ alpha i.+1)%N.
