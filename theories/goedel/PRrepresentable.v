 ...
 - simpl in |- *. intros a a0. unfold betaFormula in |- *.
   assert
      (H: forall (A : Formula) (v x a : nat),
       v <> x ->
       substF (existH v A) x (natToTerm a) =
       existH v (substF A x (natToTerm a))).
          ...
          with
            (existH (n + S w)
               (addExists (S w) n
                  (andH
                     (andH
                        (substF (equal (var 0) (natToTerm (snd a))) 0
       ...
       (v' :=
        Vector.t_rec (Formula * (nat -> naryFunc n))
          ...
          (fun (pair : Formula * (nat -> naryFunc n)) (m : nat) 
           ...
           Vector.cons _
             (substF (fst pair) (S n) (natToTerm a), snd pair a) m
             rec) _ A) in *.
      assert
...
Proof.
  ...
  - rewrite (subFormulaImp LNN). rewrite (subFormulaNot LNN).
    ...
    + apply impTrans with (notH (LT (natToTerm a) (var v))).
      * apply impI. 
        apply impE with (notH (notH (substF B v (natToTerm a)))).
        apply cp2.
        -- apply Axm; right; constructor.
           ...
           ++ induction (eq_nat_dec v x) as [e2 | e2]; try congruence.
              ...
              ** apply impE with (LT (var x) (natToTerm a)).
                 --- apply sysWeaken. apply boundedLT. intros n H5.
                     ...
                     apply impE with (notH (substF B v (natToTerm n))).
  ...
  existH (S (S n))
    (andH
       (minimize (primRecSigmaFormulaHelp n SigA SigB)
          ...
          (S (S (S (S n)))))
       (substF 
          (substF  betaFormula 2 (var (S (S n)))) 1 
          (var (S n)))).
   ...
   repeat
    ...
    | H:(In ?X3
           (freeVarF LNN
              (substF 
                 (substF 
                    (substF  betaFormula 1 _) 2 _) 0 _))) |- _
    =>
        decompose sum (In_betaFormula_subst_1_2_0 _ _ _ _ H); clear H
    | H:(In ?X3
           (freeVarF LNN
              (substF (substF betaFormula 1 _)
                 2 _))) |- _ =>
               ...
               (andH
                  (minimize
                     ...
                     (substF (primRecPiFormulaHelp 0 A B) 1
                        (natToTerm a)) 2 4)
                  (substF betaFormula 1 (natToTerm a)))).
        * apply (reduceExist LNN).
          -- apply closedNN.
          -- apply (reduceAnd LNN).
                ...
                ** apply (reduceAnd LNN).
                   --- assert
                        (subExistSpecial :
                         ...
                         b <> c ->
                         substF (existH b F) c (natToTerm a) =
                         existH b (substF F c (natToTerm a))).
                       ...
                       assert
                        (subForallSpecial :
                         forall (F : Formula) (a b c : nat),
                         b <> c ->
                         substF (forallH b F) c (natToTerm a) =
                         forallH b (substF F c (natToTerm a))).
                       ...
                       +++ unfold primRecSigmaFormulaHelp.
                           ...
                           *** apply existI with (natToTerm (f 0)). 
                               ...
                               ---- unfold f, evalPrimRecFunc. 
                                    ...
                                    apply impE with 
                                      (substF A 0 (natToTerm g)).
                                    ++++ apply iffE2. apply (reduceSub LNN).
                                         **** apply closedNN.
                                         **** apply iffTrans with (substF A 2 (natToTerm x)).
                                              apply (reduceSub LNN).
                                              { apply closedNN. }
                                              { apply (subFormulaNil LNN). 
                                                intro H4. 
                                    ...
                                    ++++ apply
                                          impE
                                           with (substF (equal (var 0) (natToTerm g)) 0 (natToTerm g)).
                                         **** apply iffE2. apply (reduceSub LNN).
                                              { apply closedNN. }
                                              { auto. }
                                         **** rewrite (subFormulaEqual LNN). 
                               ...
                               ---- destruct repBeta as (H1, H4). 
                                    ...
                                    ++++ apply
                                          impE
                                           with
                                             (substF (equal (var 0) (natToTerm (beta x 0))) 0
                                                (natToTerm (f 0))).
                                         **** apply iffE2. apply (reduceSub LNN).
                                              { apply closedNN. }
                                              { apply
                                                 iffTrans
                                                  with
                                                    (substF 
                                                       (substF betaFormula 2 (natToTerm x)) 1
                                                       (natToTerm 0)).
                                                - apply (subFormulaExch LNN).
                                                  + discriminate.
                                                  + apply closedNatToTerm.
                                                    ...
                                                    * apply
                                                      ...
                                                      -- apply
                                                          impE
                                                           with
                                                             (substF 
                                                                (substF (equal (var 0) (natToTerm (beta x n))) 0
                                              ...
                                              { destruct H0 as (H0, H4). simpl in H4.
                                                ...
                                                - apply
                                                   impE
                                                    with
                                                      (substF 
                                                         (substF  (substF  B 2 (natToTerm n)) 0
                                                            (natToTerm (f (S n)))) 1 (natToTerm (f n))).
                                                  + apply iffE2. repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                  ...
                                                  + apply
                                                     impE
                                                      with
                                                        (substF 
                                                           (substF  (substF B 2 (natToTerm n)) 1
                                                    ...
                                                    * apply
                                                       impE
                                                        with
                                                          (substF  (equal (var 0) (natToTerm (h n (f n)))) 0
                                                             (natToTerm (f (S n)))).
                                                      -- apply iffE2. repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                         apply H4.
                                                    ...
                                                    with
                                                      (substF 
                                                         (substF 
                                                            (substF 
                                                               (substF
                                                                  (substF betaFormula 2 (natToTerm x)) 3
                                                    ...
                                                    * simpl in H5.
                                                      apply
                                                       impE
                                                        with
                                                          (substF
                                                             (substF  (equal (var 0) (natToTerm (beta x (S n)))) 0
                                                                (natToTerm (f (S n)))) 1 (natToTerm (f n))).
                                                      -- apply iffE2. repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                         apply H5.
                                                      -- repeat rewrite (subFormulaEqual LNN). simpl.
                               ...
                               ---- destruct H as (H, H1). simpl in H1.
                                    apply
                                     impTrans
                                      with
                                        (substF 
                                           (substF  (equal (var 0) (natToTerm g)) 1 (natToTerm a))
                                           2 (natToTerm x)).
                                                    ...
                                                    * apply
                                                      ...
                                                      -- apply
                                                         ...
                                                         ++ apply
                                                             impTrans
                                                              with
                                                                (substF (equal (var 0) (natToTerm (beta x n))) 0 (var 1)).
                                                            ** apply iffE1. repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                               apply H5.
                                                            ** repeat rewrite (subFormulaEqual LNN). simpl.
                                                               repeat rewrite (subTermNil LNN (natToTerm (beta x n))).
                                                               ...
                                                               --- simpl in H5.
                                                                   apply
                                                                    impE
                                                                     with
                                                                       (substF 
                                                                          (substF  (equal (var 0) (natToTerm (beta x (S n)))) 1
                                                                             (natToTerm (f n))) 0 (natToTerm (f (S n)))).
                                                                   +++ apply iffE2. repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                                       apply H5.
                                                                   +++ repeat rewrite (subFormulaEqual LNN). simpl.
                             ...
                             ---- apply
                                   impE
                                    with
                                      (existH 0
                                         (andH
                                            (substF  (substF  A 1 (natToTerm a)) 2
                                               (natToTerm b))
                                            (substF 
                                               (substF 
                                                  (substF 
                                            ...
                                            { destruct H as (H, H1). simpl in H1. apply eqSym. unfold f; simpl.
                                              ...
                                              - apply
                                                ...
                                                + apply sysWeaken. apply iffE1.
                                                  apply iffTrans with (substF  A 2 (natToTerm b)).
                                              ...
                                              - apply sysWeaken. apply iffE1.
                                                apply
                                                 iffTrans
                                                  with
                                                    (substF 
                                                       (substF  betaFormula 2 (natToTerm b)) 1
                                                       (natToTerm 0)).
                                                + rewrite (subFormulaId LNN).
                                                  apply
                                                   iffTrans
                                        ...
                                        impE
                                         with
                                           (forallH 3
                                              (impH 
                                                 (substF 
                                                    (substF  (LT (var 3) (var 1)) 1 (natToTerm a)) 2
                                                    (natToTerm b))
                                                 (existH 0
                                                    (existH 1
                                                       (andH
                                                ...
                                                (existH 0
                                                   (existH 1
                                                      (andH
                                                         ...
                                                         (andH
                                                            (substF 
                                                               (substF  (substF  B 2 (var 3))
                                                                  2 (natToTerm b)) 3 (natToTerm x0))
                                                            (substF 
                                                               (substF 
                                                                  (substF 
                                                                     (substF  betaFormula 1 (Succ (var 3)))
                                                                 ...
                                                                 +++ apply
                                                                      iffTrans
                                                                       with
                                                                         (substF 
                                                                            (substF 
                                                                               (substF  betaFormula 2 (natToTerm b)) 3
                                                                               (natToTerm x0)) 1
                                                                            (substT  _ (Succ (var 3)) 3 (natToTerm x0))).
                                                                     *** apply (subSubFormula LNN).
                                                                         ---- discriminate.
                                                                         ---- apply closedNatToTerm.
                                                                     *** simpl.
                                                     ...
                                                     -- apply
                                                        ...
                                                        ++ do 2 apply sysWeaken. destruct H0 as (H0, H2). simpl in H2. apply iffE1.
                                                           apply
                                                            iffTrans
                                                             with
                                                               (substF  (substF  B 2 (natToTerm x0)) 1
                                                                  (natToTerm (beta b x0))).
                                                           ** apply
                                                               iffTrans
                                                                with
                                       ...
                                       **** apply impI. rewrite (subFormulaImp LNN).
                                            ...
                                            { apply sysWeaken.
                                              apply
                                               impTrans
                                                with
                                                  (substF  (equal (var 0) (natToTerm (beta b 0))) 0
                                                     (natToTerm (f 0))).
                                              - apply iffE1. apply (reduceSub LNN).
                                                + apply closedNN.
                                            ...
                                            { apply
                                              ...
                                              - apply sysWeaken.
                                                apply
                                                 impE
                                                  with
                                                    (substF  (equal (var 0) (natToTerm (f 0))) 0
                                                       (natToTerm (f 0))).
                                              ...
                                              - repeat first
                                                ...
                                                + repeat first
                                                  ...
                                                  apply
                                                   impE
                                                    with
                                                      (substF  (equal (var 0) (natToTerm (beta b (S x0)))) 0
                                                         (natToTerm (f (S x0)))).
                                                  * rewrite (subFormulaEqual LNN). simpl. rewrite (subTermNil LNN).
                                                    -- apply impRefl.
                                                    -- apply closedNatToTerm.
                                                                         ...
                                                                         (substF 
                                                                            (substF 
                                                                               (substF 
                                                                                  (substF  betaFormula 2 (natToTerm b)) 3
                                                                                  (natToTerm x0)) 1
                                                                               (substT _ (Succ (var 3)) 3 (natToTerm x0))) 1
                                                                            (natToTerm (beta b x0))).
                                                                     *** repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                                         apply (subSubFormula LNN).
                                                                         ---- discriminate.
                                                          ...
                                                          ** do 2 apply sysWeaken.
                                                             apply
                                                              impE
                                                               with
                                                                 (substF 
                                                                    (substF  (equal (var 1) (natToTerm (beta b x0))) 0
                                                                       (natToTerm (f (S x0)))) 1 (natToTerm (beta b x0))).
                                                             --- apply iffE2. repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                                 destruct H0 as (H0, H1). destruct repBeta as (H2, H3). simpl in H3.
                                                                 apply
  ...
  { apply closedNatToTerm. }
                                                       ...
                                                       ++ apply
                                                          ...
                                                          ** do 2 apply sysWeaken.
                                                             ...
                                                             --- apply
                                                                  impE
                                                                   with
                                                                     (substF  (equal (var 0) (natToTerm (f (S x0)))) 0
                                                                        (natToTerm (f (S x0)))).
                                                                 +++ apply iffE2. apply (reduceSub LNN).
                                                                     *** apply closedNN.
           ...
           ++ apply
               iffTrans
                with
                  (substF 
                     (substF  betaFormula 1 (natToTerm a)) 2 
                     (natToTerm x)).
              ** apply iffI.
                 --- apply impI. apply existSys.
                     +++ apply closedNN.
      ...
      + destruct H as (H, H1). destruct H0 as (H0, H2). simpl in H1. simpl in H2.
        assert
         (H3: RepresentableHelp n
            ...
            (substF 
               (primRecSigmaFormula n (substF  A (S n) (natToTerm a0))
                  (substF 
                     (substF 
                        (substF  B (S n) (natToTerm a0))
                 ...
                 -- apply
                    ...
                    ++ apply
                        iffTrans
                         with
                           (substF 
                              (substF  (substF B (S n) (natToTerm a0))
        ...
        * clear H3 Hrecn. apply iffSym.
          apply
           iffTrans
            with
              (substF 
                 (substF  (primRecSigmaFormula (S n) A B) 
...
Opaque substF.
                ...
                ** apply
                    iffTrans
                     with
                       (substF (substF  A (S n) (natToTerm a0))
                          (S (S (S n))) (var (S (S n)))).
                         ...
                         with
                           (substF 
                              (substF 
                                 (substF 
                                    (substF 
                                       (substF betaFormula 1 (var (S (S (S (S n))))))
                                ...
                                iffTrans
                                 with
                                   (substF 
                                      (substF 
                                         (substF 
                                            (substF betaFormula 1 (var (S (S (S (S n)))))) 2
                                            (var (S (S n)))) 0 (var (S n))) (S (S (S (S n))))
                                      (var (S (S (S n))))).
                               ---- repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                    apply (subFormulaTrans LNN). PRsolveFV A B n.
                       ...
                       +++ apply
                            iffTrans
                             with
                               (substF 
                                  (substF 
                                     (substF  betaFormula 1 (Succ (var (S (S (S (S n)))))))
                            ...
                            iffTrans
                             with
                               (substF  (substF  A (S n) (natToTerm a0))
                                  (S (S (S (S (S n))))) (var (S (S (S (S n)))))).
                           *** repeat (apply (reduceSub LNN); [ apply closedNN |]). apply (subFormulaNil LNN); PRsolveFV A B n.
                           *** apply iffTrans with (substF A (S n) (natToTerm a0)).
                               ---- repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                    apply (subFormulaNil LNN); PRsolveFV A B n.
                                                 ...
                                                 iffTrans
                                                  with
                                                    (substF 
                                                       (substF 
                                                          (substF 
                                                             (substF  betaFormula 1 (var (S (S (S n))))) 2
                                                             (var (S (S (S (S (S n))))))) 0 (var (S n)))
                                                       (S (S (S (S (S n))))) (var (S (S (S (S n)))))).
                                                - repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                  apply (subFormulaTrans LNN); PRsolveFV A B n.
                                    ...
                                    ++++ apply
                                         ...
                                         **** apply
                                               iffTrans
                                                with
                                                  (substF 
                                                     (substF  betaFormula 1 (Succ (var (S (S (S n)))))) 2
                                                     (var (S (S (S (S n)))))).
                                              { repeat (apply (reduceSub LNN); [ apply closedNN |]).
                                                apply
                                                 iffTrans
